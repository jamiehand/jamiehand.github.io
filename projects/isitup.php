...
* Copied from https://github.com/mccreath/istiupforslack for testing a
  slash command for Slack.
...
if($token != 'jqMbQvusb0dKyTbHwH2hXAx5'){ #replace this with the token from your slash command configuration page
